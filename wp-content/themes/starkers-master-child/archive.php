...
<div class="content">
	<?php if ( have_posts() ): ?>
	<?php if ( is_day() ) : ?>
	<h2 class="heading-alt bot-mar-3">Archive: <?php echo  get_the_date( 'D F Y' ); ?></h2>							
	<?php elseif ( is_month() ) : ?>
	<h2 class="heading-alt bot-mar-3">Archive: <?php echo  get_the_date( 'F Y' ); ?></h2>	
	<?php elseif ( is_year() ) : ?>
	<h2 class="heading-alt bot-mar-3">Archive: <?php echo  get_the_date( 'Y' ); ?></h2>								
	<?php else : ?>
	<h2 class="heading-alt bot-mar-3">Archive</h2>	
	<?php endif; ?>
